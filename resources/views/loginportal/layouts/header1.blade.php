...
<head>
    ...
    <link rel="stylesheet" href="../loginportal/assets/vendor/overlay-scroll/OverlayScrollbars.min.css" />
    <link rel="stylesheet" href="../loginportal/assets/vendor/datatables/dataTables.bs5.css" />
    <link rel="stylesheet" href="../loginportal/assets/vendor/datatables/dataTables.bs5-custom.css" />
</head>
        ...
        <div class="main-container">
            <nav id="sidebar" class="sidebar-wrapper">
                ...
                <div class="sidebar-settings gap-1 d-lg-flex d-none">
                    <a href="{{ url('/customerportal/profile') }}" class="settings-icon" data-bs-toggle="tooltip" data-bs-placement="top"
                        data-bs-custom-class="custom-tooltip-danger" title="Profile">
                        <i class="bi bi-person"></i>
                    </a>
                    <a href="{{ url('/customerportal/sites') }}" class="settings-icon" data-bs-toggle="tooltip" data-bs-placement="top"
                        data-bs-custom-class="custom-tooltip-danger" title=" Sites">
                        <i class="bi bi-pin-map"></i>
                    </a>
                    <a href="{{ url('/customerportal/reports') }}" class="settings-icon" data-bs-toggle="tooltip" data-bs-placement="top"
                        data-bs-custom-class="custom-tooltip-danger" title=" Reports">
                        <i class="bi bi-bar-chart-line"></i>
                    </a>
                    <a href="{{ url('/customerportal/settings') }}" class="settings-icon" data-bs-toggle="tooltip" data-bs-placement="top"
                        data-bs-custom-class="custom-tooltip-danger" title=" Settings">
                        <i class="bi bi-gear"></i>
                    </a>
                    <a href="{{ url('/customerportal/logout') }}" class="settings-icon" data-bs-toggle="tooltip" data-bs-placement="top"
                        data-bs-custom-class="custom-tooltip-danger" title="Logout">
                    ...
                    <div class="header-actions">
                        <div class="dropdown ms-4">
                            <a id="userSettings" class="dropdown-toggle d-flex py-2 align-items-center" href="#!"
                                ...
                                <img src="{{'../' . Session('customer')->profile_image }}" class="rounded-4 img-3x" alt="Bootstrap Gallery" />
                            ...
                            <div class="dropdown-menu dropdown-menu-end shadow-lg">
                                <a class="dropdown-item d-flex align-items-center" href="{{ url('/customerportal/profile') }}"><i
                                        class="bi bi-person fs-5 me-2"></i>My Profile</a>
                                <a class="dropdown-item d-flex align-items-center" href="{{ url('/customerportal/settings') }}"><i
