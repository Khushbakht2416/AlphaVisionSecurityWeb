    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">New Notification Information</h5>
                        <p>Select a User and enter the notification details below.</p>
                        <form method="POST" action="{{ url('/loginportal/send-new-notification') }}" enctype="multipart/form-data">
                            @csrf
