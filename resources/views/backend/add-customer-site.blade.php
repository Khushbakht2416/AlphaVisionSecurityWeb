...
@section('main-container')
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Add New Site for User: {{ $customer->full_name }}</h1>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form id="multiStepForm" method="POST"
                                action="{{ url('/loginportal/create-site/' . $customer->id) }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="software_credentials" class="form-control"
                                                value="{{ old('software_credentials') }}">
    ...
    <script>
        ...
        document.getElementById('multiStepForm').addEventListener('submit', function(e) {
            const checkedDays = document.querySelectorAll('.day-selector:checked');

            if (checkedDays.length === 0) {
                e.preventDefault();
                alert("Please select at least one timing day before submitting.");
                return false;
            }
            document.querySelectorAll('.day-selector').forEach(checkbox => {
                checkbox.addEventListener('change', function() {
