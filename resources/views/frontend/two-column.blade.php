...
<!-- Mirrored from html.designingmedia.com/redlight/two-column.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Mar 2025 10:20:07 GMT -->
<head>
<meta charset="UTF-8"/>
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
<title>Two Columns | RedLight</title>
...
<link rel="stylesheet" href="assets/css/super-class.html"/>
<link rel="stylesheet" href="assets/css/custom-style.css"/>
<link rel="stylesheet" href="assets/css/owl.carousel.min.html"/>
          ...
          <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
              <a class="navbar-brand pt-0" href="index-2.html">
                <img src="assets/images/new_logo.png" alt="" class="img-fluid" style="height: 50px; width: auto;" />
              </a>
                  ...
                  <span class="navbar-toggler-icon"></span>
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                          <ul class="navbar-nav">
                              <li class="nav-item">
                                  <a class="nav-link text-decoration-none navbar-text-color home-margin-top" href="index-2.html">Home<span class="sr-only">(current)</span></a>
                              </li>
                              <li class="nav-item">
                              ...
                              <li class="nav-item dropdown redlight-dropdown active">
                                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blogs</a>
                                      <div class="dropdown-menu dropdown-content-redlight blogs-section-drop-down">
                                          <ul class="list-unstyled">
                                              ...
                                              <li class="nav-item"> <a class="dropdown-item fierce-menu nav-link active" href="two-column.html">Two Column</a></li>
                              ...
                              <li class="nav-item navbar-text-color"><a class="nav-link text-decoration-none contact-us-margin navbar-text-color" href="pricing-page.html">Pricing</a></li>
                          </ul>
              ...
              <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 mb-md-0 mb-4  text-center">
                      <div class="about-banner-text"  data-aos="fade-up">
                          <h1 class="text-white about-h1" data-aos="zoom-out-left">Blog - Two Column</h1>
                          ...
                          <div class="about-btn">
                              <a href="one-column.html" class="text-decoration-none">Blog <span class="about-text-color"> / Two Column</span></a>
                          </div>
                      </div>
                  </div>
              </div>
            ...
            <div class="col-xl-6">
              <div class="float-left w-100 post-item border mb-4">
                <div class="post-item-wrap position-relative">
                  <div class="post-image">
                    <a href="#">
                      <img alt="" src="assets/images/post-featured4.jpg" />
                    </a>
                    <span class="post-meta-category">
                      <a href="#">Science</a>
                    </span>
              ...
              <div class="float-left w-100 post-item border mb-4">
                <div class="post-item-wrap position-relative">
                  <div class="post-audio position-relative">
                    <a href="#">
                      <img alt="" src="assets/images/post-featured3.jpg" />
                    </a>
                    <span class="post-meta-category">
                      <a href="#">Audio</a>
                    </span>
              ...
              <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-6">
                      <div class="footer-content1" data-aos="flip-left">
                          <figure>
                              <a href="index-2.html"><img src="assets/images/redlight-logo.png" alt="" class="img-fluid" /></a>
                          </figure>
                  ...
                  <div class="col-xl-2 col-lg-3 col-md-2 col-sm-12 d-lg-block d-none">
                      <ul class="list-unstyled services-footer" data-aos="flip-left">
                          ...
                          <li>
                              ...
                              <a href="index-2.html" class="text-decoration-none footer-link-p">
                                  Threat Hunter
                              </a>
                          </li>
                          <li>
